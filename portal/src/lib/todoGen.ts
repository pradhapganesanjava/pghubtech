...
export const DEFAULT_TODO_GENERATE_PROMPT = [
  ...
  `  "todos": [`,
  `    {`,
  `      "title":       "KEYWORDS, not a sentence: 3-7 words, imperative, under 55 chars. The list is scanned, not read. Say 'Define LLM client interface', not 'Define LLM client interface with generate and stream methods' — the qualifiers belong in the description. Never repeat words the parent already says.",`,
  `      "description": "1-4 sentences: the WHY, acceptance criteria, key terminology, and (for technical topics) the specific tool / command / concept involved. The FIRST sentence must stand alone under ~60 chars — it is shown greyed beside the title as the one-glance explanation.",`,
