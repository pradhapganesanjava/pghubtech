              ...
              <div className="adshub-detail-body">
                ...
                <div className="adshub-desc-code-split" ref={descCodeRef}>
                  <div className="adshub-desc-col">
                    ...
                    {/* AI now renders in the RIGHT-column CodePanel slot
                        (same place as Notes) — see overlay prop below. */}
                  </div>
                  {!codeCollapsed && (
                    <div
                      className="qa-divider"
                    ...
                    {codeCollapsed ? (
                      <div className="adshub-code-strip">
                        ...
                        <button
                          ...
                          // AI overlays the right-column slot (like Notes).
                          // Auto-expand the panel + close Notes for
                          // mutual exclusion.
                          onClick={() => {
                            setAiOpen(true)
                            setNoteMode('hidden')
