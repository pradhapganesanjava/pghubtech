...
const GROUPS = {
  ...
  design:         [281, 352, 380, 604, 1244, 2336, 2694, 1206, 10048, 10057, 10061, 10062, 10064],
  simulation:     [68, 289, 422, 794, 1958, 2303, 10008, 10063],
}
...
const SUBGROUPS = {
  ...
  design: {
    ...
    'reactive-filter-emit':   [10061],
    'self-ordered-structure': [1206, 10062],
    'soft-delete-tree':        [10064],
  },
  simulation: {
    'line-format':            [68],
    'grid-simulate':          [289],
    'board-validate':         [422, 794, 1958, 10008, 10063],
    'tiered-scan':            [2303],
  },
}
